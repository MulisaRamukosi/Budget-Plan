...
import com.puzzle.industries.domain.usescases.expenseGroup.DeleteExpenseGroupUseCase

class DeleteExpenseGroupUseCaseImpl constructor(
    private val expenseGroupRepository: ExpenseGroupRepository,
    private val expenseGroupHistoryRepository: ExpenseGroupHistoryRepository
) : DeleteExpenseGroupUseCase,
    HistoryGeneratorDelegate<ExpenseGroup, ExpenseGroupHistory> by ExpenseGroupHistoryGenerator() {

    override suspend fun delete(reason: String, vararg entity: ExpenseGroup): Response<Boolean> {
        val result = expenseGroupRepository.delete(entity = entity)
