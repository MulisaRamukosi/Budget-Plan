...
class MainActivity : ComponentActivity() {
    ...
    @Inject lateinit var themePreferences: ThemeDataStore
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContent {
            ...
            val themeType by themePreferences.getSelectedTheme().collectAsState(initial = ThemeType.SYSTEM_DEPENDENT)
